...
CREATE INDEX idx_lahtokoulut_oppilaitos_oid ON lahtokoulut (oppilaitos_oid) WHERE upper(versio_voimassaolo) = 'infinity'::timestamptz;
...
CREATE INDEX idx_lahtokoulut_valmistumisvuosi ON lahtokoulut (valmistumisvuosi) WHERE upper(versio_voimassaolo) = 'infinity'::timestamptz;
