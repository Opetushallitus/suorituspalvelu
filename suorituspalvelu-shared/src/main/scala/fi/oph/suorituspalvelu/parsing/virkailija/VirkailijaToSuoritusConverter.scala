    ...
    PerusopetuksenOpiskeluoikeus(
      ...
      Set(
        PerusopetuksenOppimaara(
          ...
          aineet = aineet,
          lahtokoulut = Set(Lahtokoulu(LocalDate.now, vahvistusPaivamaara, suoritus.oppilaitosOid.get, Some(LocalDate.now.getYear), luokka, Some(supaTila), Some(yhteisenAineenArvosanaPuuttuu(aineet)), VUOSILUOKKA_9)), // TODO: pitäisikö kälistä tulla tieto kotiopetus vs. ahvenanmaalainen?
          syotetty = true
        )
      ),
      None,
