...
object YosConstants {
  ...
  def KOULUTUSASTE_ALIMMAN_KORKEA_ASTEEN_KOULUTUS = "52"
  def KOULUTUSASTE_AMMATILLINEN_KORKEA_ASTE = "61" //tarviiko?
  def KOULUTUSASTE_AMK = "62"
  def KOULUTUSASTE_YAMK = "71"
  def KOULUTUSASTE_LISENSIAATINTUTKINTO = "81"
  def KOULUTUSASTE_TOHTORIN_TUTKINTO = "82"
