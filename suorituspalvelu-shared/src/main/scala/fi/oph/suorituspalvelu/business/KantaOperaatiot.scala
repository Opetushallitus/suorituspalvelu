          ...
          WITH RECURSIVE
            ...
            w_ammatilliset_tutkinnot AS (
              SELECT
                ...
                jsonb_build_object('nimi', nimi, 'tyyppi', jsonb_build_object('arvo', tyyppi, 'koodisto', koodisto, 'versio', koodistoversio), 'tila', jsonb_build_object('arvo', tila, 'koodisto', tilakoodisto, 'versio', tilaversio), 'vahvistusPaivamaara', vahvistuspaivamaara, 'keskiarvo', keskiarvo, 'suoritustapa', jsonb_build_object('arvo', suoritustapa, 'koodisto', suoritustapakoodisto, 'versio', suoritustapaversio))::text AS data,
            ...
            w_ammatillisen_tutkinnon_osat AS (
              SELECT
                ...
                jsonb_build_object('nimi', nimi, 'koodi', jsonb_build_object('arvo', koodi, 'koodisto', koodisto, 'versio', koodistoversio), 'yto', yto, 'arvosana', CASE WHEN arvosana IS NOT NULL THEN jsonb_build_object('arvo', arvosana, 'koodisto', arvosanaasteikko, 'versio', arvosanaversio) ELSE null END, 'laajuus', laajuus, 'laajuusKoodi', jsonb_build_object('arvo', laajuuskoodi, 'koodisto', laajuuskoodisto, 'versio', laajuusversio))::text AS data,
                null::text AS versio
            ...
            w_ammatillisen_tutkinnon_osaalueet AS (
              SELECT
                ...
                jsonb_build_object('nimi', nimi, 'koodi', jsonb_build_object('arvo', koodi, 'koodisto', koodisto, 'versio', koodistoversio), 'arvosana', CASE WHEN arvosana IS NOT NULL THEN jsonb_build_object('arvo', arvosana, 'koodisto', arvosanaasteikko, 'versio', arvosanaversio) ELSE null END, 'laajuus', laajuus, 'laajuusKoodi', jsonb_build_object('arvo', laajuuskoodi, 'koodisto', laajuuskoodisto, 'versio', laajuusversio))::text AS data,
                null::text AS versio
