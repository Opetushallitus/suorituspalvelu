...
class KantaOperaatiotTest {
  ...
  @Test def testKoskiSkip(): Unit = {
    ...
    val oppijanSuoritukset = this.kantaOperaatiot.haeSuorituksetAjanhetkella(henkiloOid, Instant.now(), useKoskiSkipTable = false)
    val oppijanSuorituksetWithSkips = this.kantaOperaatiot.haeSuorituksetAjanhetkella(henkiloOid, Instant.now(), useKoskiSkipTable = true)
