...
class KantaOperaatiotTest {
  ...
  @Test def testSuoritusRoundtrip(): Unit =
    ...
    val suoritukset = PerusopetuksenOppimaara("3.4.5", Koodi("arvo", "koodisto", Some(1)), Koodi("arvo", "koodisto", Some(1)), Set.empty, None, Set(PerusopetuksenOppiaine("äidinkieli", Koodi("arvo", "koodisto", None), Koodi("10", "koodisto", None))))
  ...
  @Test def testVanhatSuorituksetPoistetaanUusienTieltä(): Unit =
    ...
    val suoritus1 = PerusopetuksenOppimaara(OPPILAITOSOID1, Koodi("arvo", "koodisto", Some(1)), Koodi("arvo", "koodisto", Some(1)), Set.empty, None, Set(PerusopetuksenOppiaine("äidinkieli", Koodi("arvo", "koodisto", None), Koodi("10", "koodisto", None))))
    ...
    val suoritus2 = PerusopetuksenOppimaara(OPPILAITOSOID2, Koodi("arvo", "koodisto", Some(1)), Koodi("arvo", "koodisto", Some(1)), Set.empty, None, Set(PerusopetuksenOppiaine("englanti", Koodi("arvo", "koodisto", None), Koodi("10", "koodisto", None))))
  ...
  @Test def testPalautetaanViimeisinParseroituVersio(): Unit =
    ...
    val suoritus = PerusopetuksenOppimaara("3.4.5", Koodi("arvo", "koodisto",  Some(1)), Koodi("arvo", "koodisto", Some(1)), Set.empty, None, Set(PerusopetuksenOppiaine("äidinkieli", Koodi("arvo", "koodisto", None), Koodi("10", "koodisto", None))))
  ...
  @Test def testPerusopetuksenOpiskeluoikeusEqualityAfterPersisting(): Unit =
    ...
    val suoritus1 = PerusopetuksenOppimaara(OPPILAITOSOID1, Koodi("arvo", "koodisto", Some(1)), Koodi("arvo", "koodisto", Some(1)), Set.empty, None, Set(PerusopetuksenOppiaine("äidinkieli", Koodi("arvo", "koodisto", None), Koodi("10", "koodisto", None))))
    val luokkasuoritus1 = PerusopetuksenVuosiluokka("vuosiluokka", Koodi("arvo1", "koodisto", Some(1)), Some(LocalDate.parse("2024-08-01")), false)
    ...
    val suoritus2 = PerusopetuksenOppimaara(OPPILAITOSOID2, Koodi("toinenarvo", "koodisto", Some(1)), Koodi("arvo", "koodisto", Some(1)), Set.empty, None, Set(PerusopetuksenOppiaine("englanti", Koodi("arvo", "koodisto", None), Koodi("10", "koodisto", None))))
    val luokkasuoritus2 = PerusopetuksenVuosiluokka("vuosiluokka2", Koodi("arvo2", "koodisto", Some(1)), Some(LocalDate.parse("2023-08-01")), false)
    ...
    val opiskeluoikeus2 = PerusopetuksenOpiskeluoikeus(OPISKELUOIKEUSOID2, OPPILAITOSOID2, Set(suoritus2, luokkasuoritus2), Some(lisatiedot2), Some(tilat2))
  ...
  @Test def testGeneerinenOpiskeluoikeusEqualityAfterPersisting(): Unit =
    val OPPIJANUMERO1 = "1.2.246.562.24.99988877766"
    val versio = this.kantaOperaatiot.tallennaJarjestelmaVersio(OPPIJANUMERO1, KOSKI, "{\"attr\": \"value\"}").get
    val suoritus = Tuva(Koodi("arvo", "koodisto", None), Some(LocalDate.parse("2025-03-20")))
    ...
    val opiskeluoikeus = GeneerinenOpiskeluoikeus("opiskeluoikeusOid", Koodi("arvo", "koodisto", None), "oppilaitosOid", Set(suoritus), Some(tilat))
    this.kantaOperaatiot.tallennaVersioonLiittyvatEntiteetit(versio, Set(opiskeluoikeus), Set.empty)
