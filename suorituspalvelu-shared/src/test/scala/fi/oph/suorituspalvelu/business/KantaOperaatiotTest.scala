...
class KantaOperaatiotTest {
  ...
  @Test def testPerusopetuksenOpiskeluoikeusEqualityAfterPersisting(): Unit =
    ...
    val suoritus1 = PerusopetuksenOppimaara(OPPILAITOSOID1, Koodi("arvo", "koodisto", Some(1)), Set.empty, None, Set(PerusopetuksenOppiaine("äidinkieli", "koodi", "10")))
    val luokkasuoritus1 = PerusopetuksenVuosiluokka("vuosiluokka", "koodi", Some(LocalDate.parse("2024-08-01")), false)
    ...
    val luokkasuoritus2 = PerusopetuksenVuosiluokka("vuosiluokka2", "koodi2", Some(LocalDate.parse("2023-08-01")), false)
