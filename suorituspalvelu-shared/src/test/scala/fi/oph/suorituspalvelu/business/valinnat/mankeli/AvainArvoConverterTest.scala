...
class AvainArvoConverterTest {
  ...
  private def ebOpiskeluoikeus(supaTila: SuoritusTila, vahvistusPaivamaara: Option[LocalDate]): GeneerinenOpiskeluoikeus = {
