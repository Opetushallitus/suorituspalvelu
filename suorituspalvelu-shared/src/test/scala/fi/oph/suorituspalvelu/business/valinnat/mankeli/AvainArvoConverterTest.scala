...
class AvainArvoConverterTest {
  ...
  @Test def testAvainArvoConverterForPeruskouluKeys(): Unit = {
    ...
    val converterResult = AvainArvoConverter.convertOpiskeluoikeudet("1.2.246.562.98.69863082363", None, opiskeluoikeudet, leikkuri, DEFAULT_KOUTA_HAKU, None, Map.empty)
  ...
  @Test def testKorkeimmatArvosanat(): Unit = {
    ...
    val converterResult = AvainArvoConverter.convertOpiskeluoikeudet("1.2.3", Some(BASE_HAKEMUS), Seq(baseOpiskeluoikeus, korotus1Opiskeluoikeus, korotus2Opiskeluoikeus), leikkuriPaiva, DEFAULT_KOUTA_HAKU, None, Map.empty)
  ...
  @Test def testOrpoaOppiaineenOppimaaraaEiKuuluHuomioida(): Unit = {
    ...
    val leikkuriPaiva = LocalDate.now()
    val converterResult = AvainArvoConverter.convertOpiskeluoikeudet("1.2.3", Some(BASE_HAKEMUS), Seq(baseOpiskeluoikeus, korotus1Opiskeluoikeus, orpoOppiaineMaantietoOpiskeluoikeus), leikkuriPaiva, DEFAULT_KOUTA_HAKU, None, Map.empty)
    val avainArvoMap = converterResult.getAvainArvoMap()
    println(s"korkeimmatArvosanat: $avainArvoMap")
  ...
  @Test def testYoArvoEnnenLeikkuripaivaa(): Unit = {
    ...
    val converterResult = AvainArvoConverter.convertOpiskeluoikeudet(personOid, None, oikeudet, leikkuri, DEFAULT_KOUTA_HAKU, None, Map.empty)
  ...
  @Test def testAmmArvoMyohassaValmistunut(): Unit = {
    ...
    val converterResult = AvainArvoConverter.convertOpiskeluoikeudet(personOid, None, oikeudet, leikkuriPaiva, DEFAULT_KOUTA_HAKU, None, Map.empty)
  ...
  @Test def testTelmaRiittavaLaajuus(): Unit = {
    ...
    val converterResult = AvainArvoConverter.convertOpiskeluoikeudet(personOid, Some(hakemus), Seq(suoritettuPerusopetus, telmaOikeus), leikkuriPaiva, DEFAULT_KOUTA_HAKU, None, Map.empty)
    ...
    val converterResultWithoutPerusopetus = AvainArvoConverter.convertOpiskeluoikeudet(personOid, Some(hakemus), Seq(telmaOikeus), leikkuriPaiva, DEFAULT_KOUTA_HAKU, None, Map.empty)
  ...
  @Test def testTelmaRiittamatonLaajuus(): Unit = {
    ...
    val converterResult = AvainArvoConverter.convertOpiskeluoikeudet(personOid, Some(hakemus), Seq(telmaOikeus, suoritettuPerusopetus), leikkuriPaiva, DEFAULT_KOUTA_HAKU, None, Map.empty)
  ...
  @Test def testTelmaLiianVanhaSuoritus(): Unit = {
    ...
    val converterResult = AvainArvoConverter.convertOpiskeluoikeudet(personOid, None, oikeudet, leikkuriPaiva, haku, None, Map.empty)
  ...
  @Test def testTuvaRiittavaLaajuus(): Unit = {
    ...
    val converterResult = AvainArvoConverter.convertOpiskeluoikeudet(personOid, Some(hakemus), Seq(tuvaOikeus, suoritettuPerusopetus), leikkuriPaiva, DEFAULT_KOUTA_HAKU, None, Map.empty)
    Assertions.assertEquals(Some(AvainArvoConstants.POHJAKOULUTUS_PERUSKOULU), converterResult.getAvainArvoMap().get(AvainArvoConstants.pohjakoulutusToinenAste))
    ...
    //Lisäpistekoulutuksia ei huomioida, jos pohjakoulutus on POHJAKOULUTUS_ULKOMAILLA_SUORITETTU_KOULUTUS tai POHJAKOULUTUS_EI_PAATTOTODISTUSTA
    val converterResultWithoutPerusopetus = AvainArvoConverter.convertOpiskeluoikeudet(personOid, Some(hakemus), Seq(tuvaOikeus), leikkuriPaiva, DEFAULT_KOUTA_HAKU, None, Map.empty)
    Assertions.assertEquals(Some(AvainArvoConstants.POHJAKOULUTUS_EI_PAATTOTODISTUSTA), converterResultWithoutPerusopetus.getAvainArvoMap().get(AvainArvoConstants.pohjakoulutusToinenAste))
  ...
  @Test def testOpistovuosiRiittavaLaajuus(): Unit = {
    ...
    val converterResult = AvainArvoConverter.convertOpiskeluoikeudet(personOid, Some(hakemus), Seq(opistovuosiOikeus, suoritettuPerusopetus), leikkuriPaiva, DEFAULT_KOUTA_HAKU, None, Map.empty)
    Assertions.assertEquals(Some(AvainArvoConstants.POHJAKOULUTUS_PERUSKOULU), converterResult.getAvainArvoMap().get(AvainArvoConstants.pohjakoulutusToinenAste))
    ...
    //Lisäpistekoulutuksia ei huomioida, jos pohjakoulutus on POHJAKOULUTUS_ULKOMAILLA_SUORITETTU_KOULUTUS tai POHJAKOULUTUS_EI_PAATTOTODISTUSTA
    val converterResultWithoutPerusopetus = AvainArvoConverter.convertOpiskeluoikeudet(personOid, Some(hakemus), Seq(opistovuosiOikeus), leikkuriPaiva, DEFAULT_KOUTA_HAKU, None, Map.empty)
  ...
  @Test def testAvainArvoConverterForToisenAsteenPohjakoulutusLoytyySupasta(): Unit = {
    ...
    val leikkuri = LocalDate.now
    val converterResult = AvainArvoConverter.convertOpiskeluoikeudet(personOid, Some(hakemus), Seq(opiskeluoikeus), leikkuri, DEFAULT_KOUTA_HAKU, None, Map.empty)
  ...
  @Test def testAvainArvoConverterForToisenAsteenPohjakoulutusArvosanoissaNelosiaSuoritusKesken(): Unit = {
    ...
    val converterResultVSOPNelosia = AvainArvoConverter.convertOpiskeluoikeudet("1.2.246.562.98.69863082363", Some(hakemus), Seq(opiskeluoikeusVSOPNelosia), leikkuriDeadlineOhitettu, DEFAULT_KOUTA_HAKU, None, Map.empty)
    val converterResult2VSOPEiNelosia = AvainArvoConverter.convertOpiskeluoikeudet("1.2.246.562.98.69863082363", Some(hakemus), Seq(opiskeluoikeusVSOPEiNelosia), leikkuriDeadlineOhitettu, DEFAULT_KOUTA_HAKU, None, Map.empty)
    val converterResult3Nelosia = AvainArvoConverter.convertOpiskeluoikeudet("1.2.246.562.98.69863082363", Some(hakemus), Seq(opiskeluoikeusNelosia), leikkuriDeadlineOhitettu, DEFAULT_KOUTA_HAKU, None, Map.empty)
    val converterResult4EiNelosia = AvainArvoConverter.convertOpiskeluoikeudet("1.2.246.562.98.69863082363", Some(hakemus), Seq(opiskeluoikeusEiNelosia), leikkuriDeadlineOhitettu, DEFAULT_KOUTA_HAKU, None, Map.empty)
  ...
  @Test def testAvainArvoConverterForToisenAsteenPohjakoulutusUskotaanHakemukseenUlkomainen(): Unit = {
    ...
    val leikkuri = LocalDate.now
    val converterResult = AvainArvoConverter.convertOpiskeluoikeudet("1.2.246.562.98.69863082363", Some(hakemus), Seq.empty, leikkuri, DEFAULT_KOUTA_HAKU, None, Map.empty)
  ...
  @Test def testArvosanatHakemukseltaJaYksiKorotusSupasta(): Unit = {
    ...
    val converterResult = AvainArvoConverter.convertOpiskeluoikeudet("1.2.3", Some(hakemus), Seq(korotus1Opiskeluoikeus, orpoOppiaineFysiikkaOpiskeluoikeus), LocalDate.now(), DEFAULT_KOUTA_HAKU, None, Map.empty)
  ...
  @Test def peruskouluPaattotodistusVuosiHakemukselta(): Unit = {
    ...
    val leikkuri = LocalDate.now
    val converterResultWithRekisteriPeruskoulu = AvainArvoConverter.convertOpiskeluoikeudet(personOid, Some(hakemus), Seq.empty, leikkuri, DEFAULT_KOUTA_HAKU, None, Map.empty)
  ...
  @Test def testAvainArvoConverterHakemuksenArvosanojaEiHuomioidaJosRekisteristaLoytyyPerusopetus(): Unit = {
    ...
    val leikkuri = LocalDate.now
    val converterResultWithRekisteriPeruskoulu = AvainArvoConverter.convertOpiskeluoikeudet(personOid, Some(hakemus), Seq(opiskeluoikeus), leikkuri, DEFAULT_KOUTA_HAKU, None, Map.empty)
    ...
    val converterResultWithoutRekisteriPeruskoulu = AvainArvoConverter.convertOpiskeluoikeudet(personOid, Some(hakemus), Seq.empty, leikkuri, DEFAULT_KOUTA_HAKU, None, Map.empty)
  ...
  @Test def testYksMatAi(): Unit = {
    ...
    val converterResultWithYksMatAi = AvainArvoConverter.convertOpiskeluoikeudet(personOid, None, Seq.empty, leikkuri, DEFAULT_KOUTA_HAKU, Some(hakemuksenHarkinnanvaraisuusYksMatAi), Map.empty)
    ...
    val converterResultWithoutYksMatAi = AvainArvoConverter.convertOpiskeluoikeudet(personOid, None, Seq.empty, leikkuri, DEFAULT_KOUTA_HAKU, Some(hakemuksenHarkinnanvaraisuusWithoutYksMatAi), Map.empty)
  ...
  @Test def testAvainArvoConverterForToisenAsteenPohjakoulutusLuokkaAsteEnnenLeikkuria(): Unit = {
    ...
    val resultLuokka9 = AvainArvoConverter.convertOpiskeluoikeudet("1.2.246.562.98.69863082363", Some(hakemus), Seq(opiskeluoikeusLuokka9), leikkuriDeadlineEiOhitettu, DEFAULT_KOUTA_HAKU, None, Map.empty)
    ...
    val resultLuokka8 = AvainArvoConverter.convertOpiskeluoikeudet("1.2.246.562.98.69863082363", Some(hakemus), Seq(opiskeluoikeusLuokka8), leikkuriDeadlineEiOhitettu, DEFAULT_KOUTA_HAKU, None, Map.empty)
    ...
    val resultEiLuokkaa = AvainArvoConverter.convertOpiskeluoikeudet("1.2.246.562.98.69863082363", Some(hakemus), Seq(opiskeluoikeusEiLuokkaa), leikkuriDeadlineEiOhitettu, DEFAULT_KOUTA_HAKU, None, Map.empty)
