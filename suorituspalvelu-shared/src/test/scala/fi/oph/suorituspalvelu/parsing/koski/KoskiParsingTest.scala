...
class KoskiParsingTest {
  ...
  @Test def testPerusopetuksenOppimaaranValinnaisenPakollinenVastineLuetaanSisaruksista(): Unit = {
    // Yksikkötestit (KoskiUtilTest) kattavat itse inkluusiosäännöt suoraan kutsumalla includePerusopetuksenOppiaine-
    // funktiota tietyllä pakollistenKoodit-joukolla. Tämä testi varmistaa korkeammalla tasolla  että toPerusopetuksenOppiaineet
    // kerää listan pakollisista aineista ja vain ne valinnaiset, joille löytyy samalla koodilla pakollinen vastine, otetaan huomioon.
    //  - AI pakollinen   -> mukaan (ankkuri, todistaa että wiring toimii)
    ...
    val data =
      """
        ...
        |              {
        |                "koulutusmoduuli": {
        |                  "tunniste": {"koodiarvo": "LI", "koodistoUri": "koskioppiaineetyleissivistava", "koodistoVersio": 1},
        |                  "pakollinen": false,
        |                  "laajuus": {"arvo": 3, "yksikkö": {"koodiarvo": "4", "koodistoUri": "opintojenlaajuusyksikko"}}
        |                },
        |                "arviointi": [{"arvosana": {"koodiarvo": "9", "koodistoUri": "arviointiasteikkoyleissivistava", "koodistoVersio": 1}}]
  ...
  @Test def testPerusopetuksenOppimaaranLahtokoulutEiAlkamispaivaa(): Unit =
    ...
    Assertions.assertEquals(List.empty, oppimaara.lahtokoulut)
  ...
  @Test def testPerusopetuksenOppimaaraKotiopetusJaksollaEiLoppua(): Unit = {
    val result = getFirstSuoritusFromJson(
      """
        |[
        |  {
  ...
  @Test def testPerusopetuksenOppimaaraKotiopetusEiYsiluokkaa(): Unit = {
    val result = getFirstSuoritusFromJson(
      """
        |[
        |  {
  ...
  @Test def testPerusopetuksenOppimaaraEiKotiopetustaSeiskaluokka(): Unit = {
    ...
    Assertions.assertTrue(oppimaara.isDefined)
    Assertions.assertEquals(Oppilaitos(Kielistetty(Some("Hatsalan klassillinen koulu"), None, None), "1.2.246.562.10.32727448402"), oppimaara.map(_.oppilaitos).get)
    Assertions.assertEquals(Some(LocalDate.parse("2021-06-02")), oppimaara.map(_.aloitusPaivamaara).get)
  }
  ...
  @Test def testVapaaSivistysTyoSuoritus(): Unit =
    ...
    Assertions.assertEquals(LocalDate.parse("2024-05-01"), vst.aloitusPaivamaara)
  ...
  @Test def testParasArviointiAmmatillinen15(): Unit = {
  ...
  @Test def testParasArviointiAmmatillinen15Sanallinen(): Unit = {
    val arvioinnit = Some(Set(
  ...
  @Test def testParasArviointiAmmatillinen1k3(): Unit = {
    val arvioinnit = Some(Set(
      KoskiArviointi(KoskiKoodi("3", "arviointiasteikkoammatillinent1k3", None, Kielistetty(None, None, None), None), None, true),
      KoskiArviointi(KoskiKoodi("2", "arviointiasteikkoammatillinent1k3", None, Kielistetty(None, None, None), None), None, true),
      KoskiArviointi(KoskiKoodi("Hyväksytty", "arviointiasteikkoammatillinent1k3", None, Kielistetty(None, None, None), None), None, true)
    ))
    Assertions.assertEquals(
      Some(KoskiArviointi(KoskiKoodi("3", "arviointiasteikkoammatillinent1k3", None, Kielistetty(None, None, None), None), None, true)),
      KoskiToSuoritusConverter.valitseParasAmmatillinenArviointi(arvioinnit)
    )
  }

  @Test def testParasArviointiAmmatillinenHyvaksyttyHylatty(): Unit = {
    val arvioinnit = Some(Set(
      KoskiArviointi(KoskiKoodi("Hylätty", "arviointiasteikkoammatillinenhyvaksyttyhylatty", None, Kielistetty(None, None, None), None), None, true),
      KoskiArviointi(KoskiKoodi("Hyväksytty", "arviointiasteikkoammatillinenhyvaksyttyhylatty", None, Kielistetty(None, None, None), None), None, true)
    ))
    Assertions.assertEquals(
      Some(KoskiArviointi(KoskiKoodi("Hyväksytty", "arviointiasteikkoammatillinenhyvaksyttyhylatty", None, Kielistetty(None, None, None), None), None, true)),
      KoskiToSuoritusConverter.valitseParasAmmatillinenArviointi(arvioinnit)
    )
  }

  @Test def testParasArviointiAmmatillinenMontaArviointiasteikkoaSanallinen(): Unit = {
    val arvioinnit = Some(Set(
      KoskiArviointi(KoskiKoodi("0", "arviointiasteikkoammatillinent1k3", None, Kielistetty(None, None, None), None), None, true),
      KoskiArviointi(KoskiKoodi("Hyväksytty", "arviointiasteikkoammatillinenhyvaksyttyhylatty", None, Kielistetty(None, None, None), None), None, true)
    ))
    Assertions.assertEquals(
      Some(KoskiArviointi(KoskiKoodi("Hyväksytty", "arviointiasteikkoammatillinenhyvaksyttyhylatty", None, Kielistetty(None, None, None), None), None, true)),
  ...
  @Test def testParasArviointiAmmatillinenMontaArviointiasteikkoaHyvaksyttyJaNumeerinen(): Unit = {
    val arvioinnit = Some(Set(
      KoskiArviointi(KoskiKoodi("1", "arviointiasteikkoammatillinent1k3", None, Kielistetty(None, None, None), None), None, true),
      KoskiArviointi(KoskiKoodi("Hyväksytty", "arviointiasteikkoammatillinenhyvaksyttyhylatty", None, Kielistetty(None, None, None), None), None, true)
    ))
    Assertions.assertEquals(
      Some(KoskiArviointi(KoskiKoodi("1", "arviointiasteikkoammatillinent1k3", None, Kielistetty(None, None, None), None), None, true)),
      KoskiToSuoritusConverter.valitseParasAmmatillinenArviointi(arvioinnit)
    )
  }

  @Test def testParasArviointiAmmatillinenTyhja(): Unit = {
    val arvioinnit = Some(Set.empty[KoskiArviointi])
    Assertions.assertEquals(
      None,
      KoskiToSuoritusConverter.valitseParasAmmatillinenArviointi(arvioinnit)
    )
  ...
  @Test def testIBTutkinto(): Unit = {
    ...
    Assertions.assertEquals(Some(IBOppiaineRyhma(Kielistetty(Some("Kielet: Ensimmäinen kieli"), Some("Språk: Första språket"), Some("Language: First Language")), Koodi("1", "aineryhmaib", Some(1)))), finA.ryhma)
    ...
    Assertions.assertEquals(Some(IBOppiaineRyhma(Kielistetty(Some("Matematiikka"), Some("Matematik"), Some("Mathematics")), Koodi("5", "aineryhmaib", Some(1)))), maa.ryhma)
  ...
  @Test def testIBTutkintoIlmanRyhmaa(): Unit = {
    ...
    Assertions.assertEquals(1, tutkinto.osasuoritukset.size)
    val finA = tutkinto.osasuoritukset.head
    Assertions.assertEquals(Koodi("FIN_A", "oppiaineetib", Some(1)), finA.koodi)
    Assertions.assertEquals(None, finA.ryhma)
    Assertions.assertEquals(Some(IBArvosana(Koodi("6", "arviointiasteikkoib", Some(1)), true)), finA.predictedArvosana)
  }
