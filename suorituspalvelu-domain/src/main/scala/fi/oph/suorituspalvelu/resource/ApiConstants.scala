...
object ApiConstants {
  ...
  final val LAHTOKOULU_PATH                                 = VERSIONED_API_PREFIX + "/lahtokoulu"
  final val LAHTOKOULU_HENKILOOID_PARAM_NAME                = "oppilaitosOid"
  final val LAHTOKOULU_HENKILOOID_PARAM_PLACEHOLDER         = "{" + LAHTOKOULU_HENKILOOID_PARAM_NAME + "}"
  final val LAHTOKOULU_OPISKELIJAT_PATH                     = LAHTOKOULU_PATH + "/opiskelijat/" + LAHTOKOULU_HENKILOOID_PARAM_PLACEHOLDER
