...
object UIVirheet {
  ...
  final val UI_LUO_SUORITUS_OPPILAITOKSET_HAKU_EPAONNISTUI     = "backend-virhe.luo_suoritus_oppilaitokset.haku_epaonnistui"
  final val UI_LUO_SUORITUS_VAIHTOEHDOT_HAKU_EPAONNISTUI       = "backend-virhe.luo_suoritus_vaihtoehdot.haku_epaonnistui"

  final val UI_LUO_SUORITUS_PERUSOPETUS_JSON_EI_VALIDI         = "backend-virhe.luo_perusopetuksen_oppimaara.json_ei_validi"
  ...
  final val UI_LUO_SUORITUS_PERUSOPETUS_TALLENNUS_EPAONNISTUI  = "backend-virhe.luo_perusopetuksen_oppimaara.tallennus_epaonnistui"
  ...
  final val UI_POISTA_SUORITUS_SUORITUS_EI_POISTETTAVISSA      = "backend-virhe.poista_suoritus.suoritus_ei_poistettavissa"
  final val UI_POISTA_SUORITUS_SUORITUS_EI_VOIMASSA            = "backend-virhe.poista_suoritus.suoritus_ei_voimassa"
  final val UI_POISTA_SUORITUS_TALLENNUS_EPAONNISTUI           = "backend-virhe.poista_suoritus.poisto_epaonnistui"

  final val UI_POISTA_YLIAJO_EPAONNISTUI                       = "backend-virhe.poista_yliajo.poisto_epaonnistui"
