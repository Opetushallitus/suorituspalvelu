...
export interface IKKOpintojaksoUI {
  tunniste: string;
  nimi: IKKOpintojaksoNimiUI;
  laajuus: number;
  arvosana?: string;
...
export interface ILukionOppimaaraUI {
  tunniste: string;
...
export interface IOpiskeluoikeusNimiUI {
  fi?: string;
  sv?: string;
  en?: string;
}
