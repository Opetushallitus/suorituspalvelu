...
object TypeScriptGenerator extends TypeScriptImplicits {
  def main(args: Array[String]): Unit = {
    ...
    WriteTSToFiles.generate(OutputOptions(
      ...
      "vuodetSuccess" -> vuodetSuccessResponse.get,
      "vuodetFailure" -> vuodetFailureResponse.get,
      "luokatSuccess" -> luokatSuccessResponse.get,
      "luokatFailure" -> luokatFailureResponse.get,
