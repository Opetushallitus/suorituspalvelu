        ...
        Right(None)
          ...
          .flatMap(suoritus =>
            ...
            if(versio.isEmpty)
              ...
              this.kantaOperaatiot.tallennaVersioonLiittyvatEntiteetit(versio.get, opiskeluoikeudet, KoskiUtil.getLahtokouluMetadata(opiskeluoikeudet)) //, KoskiUtil.getTallennettavaMetadata(opiskeluoikeudet.toSeq))
            }
