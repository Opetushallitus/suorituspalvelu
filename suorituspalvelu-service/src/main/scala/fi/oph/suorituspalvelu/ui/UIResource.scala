  ...
  def poistaOppijanYliajo(
    ...
    try
      ...
      case e: Exception =>
        ...
        ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(PoistaYliajotFailureResponse(java.util.Set.of(UI_POISTA_YLIAJO_VIRHE)))
  }
}
