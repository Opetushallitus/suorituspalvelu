...
class UIResource {
  ...
  def haeOppijat(
                  @RequestParam(name = UI_HAKU_OPPIJA_PARAM_NAME, required = false) @Parameter(description = "oppija", example = UI_HAKU_ESIMERKKI_HAKUKENTAN_ARVO) oppija: Optional[String],
