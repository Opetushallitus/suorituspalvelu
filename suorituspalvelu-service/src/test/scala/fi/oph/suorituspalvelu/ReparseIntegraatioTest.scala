...
import fi.oph.suorituspalvelu.business.{Koodi, Opiskeluoikeus, ParserVersions, PerusopetuksenOpiskeluoikeus, PerusopetuksenOppimaara, Lahdejarjestelma, VirtaOpiskeluoikeus, YOOpiskeluoikeus, YOTutkinto}
