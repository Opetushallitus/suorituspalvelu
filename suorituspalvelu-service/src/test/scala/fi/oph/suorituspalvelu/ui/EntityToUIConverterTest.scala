...
class EntityToUIConverterTest {
  ...
  @Test def testConvertAmmatillinenTutkintoNaytto(): Unit = {
    ...
    )), EntityToUIConverter.getOppijanTiedot("", "", "1.2.3", Set(AmmatillinenOpiskeluoikeus(UUID.randomUUID(), "1.2.3", Oppilaitos(Kielistetty(None, None, None), ""), Set(tutkinto), None)), DUMMY_ORGANISAATIOPROVIDER, DUMMY_KOODISTOPROVIDER).ammatillisetPerusTutkinnot)
  }
  ...
  @Test def testConvertAmmattiTutkinto(): Unit = {
    ...
    Assertions.assertEquals(java.util.List.of(fi.oph.suorituspalvelu.resource.ui.Ammattitutkinto(
      ...
      tutkinto.vahvistusPaivamaara.toJava,
      tutkinto.suoritusKieli.arvo,
    )), EntityToUIConverter.getOppijanTiedot("", "", "1.2.3", Set(AmmatillinenOpiskeluoikeus(UUID.randomUUID(), "1.2.3", Oppilaitos(Kielistetty(None, None, None), ""), Set(tutkinto), None)), DUMMY_ORGANISAATIOPROVIDER, DUMMY_KOODISTOPROVIDER).ammattitutkinnot)
  }
  ...
  @Test def testConvertErikoisAmmattiTutkinto(): Unit = {
    ...
    Assertions.assertEquals(java.util.List.of(fi.oph.suorituspalvelu.resource.ui.Erikoisammattitutkinto(
      ...
      tutkinto.vahvistusPaivamaara.toJava,
      tutkinto.suoritusKieli.arvo
    )), EntityToUIConverter.getOppijanTiedot("", "", "1.2.3", Set(AmmatillinenOpiskeluoikeus(UUID.randomUUID(), "1.2.3", Oppilaitos(Kielistetty(None, None, None), ""), Set(tutkinto), None)), DUMMY_ORGANISAATIOPROVIDER, DUMMY_KOODISTOPROVIDER).erikoisammattitutkinnot)
  }
  ...
  @Test def testConvertTelma(): Unit = {
    ...
    )), EntityToUIConverter.getOppijanTiedot("", "", "1.2.3", Set(AmmatillinenOpiskeluoikeus(UUID.randomUUID(), "1.2.3", Oppilaitos(Kielistetty(None, None, None), ""), Set(telma), None)), DUMMY_ORGANISAATIOPROVIDER, DUMMY_KOODISTOPROVIDER).telmat)
  }
  ...
  @Test def testConvertTuva(): Unit = {
    ...
    )), EntityToUIConverter.getOppijanTiedot("", "", "1.2.3", Set(AmmatillinenOpiskeluoikeus(UUID.randomUUID(), "1.2.3", Oppilaitos(Kielistetty(None, None, None), ""), Set(tuva), None)), DUMMY_ORGANISAATIOPROVIDER, DUMMY_KOODISTOPROVIDER).tuvat)
  }
  ...
  @Test def testConvertVapaaSivistystyoKoulutus(): Unit = {
    ...
    )), EntityToUIConverter.getOppijanTiedot("", "", "1.2.3", Set(GeneerinenOpiskeluoikeus(UUID.randomUUID(), "1.2.3", Koodi("", "", None), "", Set(vst), None)), DUMMY_ORGANISAATIOPROVIDER, DUMMY_KOODISTOPROVIDER).vapaaSivistystyoKoulutukset)
  }
  ...
  @Test def testConvertPerusopetuksenOppimaara(): Unit = {
    ...
    Assertions.assertEquals(java.util.List.of(fi.oph.suorituspalvelu.resource.ui.PerusopetuksenOppimaara(
      ...
      syotetty = true
    )), EntityToUIConverter.getOppijanTiedot("", "", "1.2.3", Set(PerusopetuksenOpiskeluoikeus(UUID.randomUUID(), Some("1.2.3"), "", Set(oppimaara), None, fi.oph.suorituspalvelu.business.SuoritusTila.VALMIS)), DUMMY_ORGANISAATIOPROVIDER, koodistoProvider).perusopetuksenOppimaarat)
  }
  ...
  @Test def testConvertOpiskeluoikeudet(): Unit = {
    ...
    )), EntityToUIConverter.getOppijanTiedot("", "", "1.2.3", Set(virtaOpiskeluoikeus), organisaatioProvider, koulutusProvider).opiskeluoikeudet)
  }
  ...
  @Test def testConvertKKTutkinto(): Unit = {
    ...
    )), EntityToUIConverter.getOppijanTiedot("", "", "1.2.3", Set(VirtaOpiskeluoikeus(null, null, null, null, null, Koodi("1", "", None), KKOpiskeluoikeusTila.VOIMASSA, virtaTutkinto.myontaja, Set(virtaTutkinto))), organisaatioProvider, DUMMY_KOODISTOPROVIDER).kkTutkinnot)
  }
  ...
  @Test def testConvertYlioppilasTutkinto(): Unit = {
    ...
    )), EntityToUIConverter.getOppijanTiedot("", "", "1.2.3", Set(YOOpiskeluoikeus(null, yoTutkinto)), DUMMY_ORGANISAATIOPROVIDER, DUMMY_KOODISTOPROVIDER).yoTutkinnot)
  }
