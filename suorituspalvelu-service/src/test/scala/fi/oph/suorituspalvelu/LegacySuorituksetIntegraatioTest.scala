...
class LegacySuorituksetIntegraatioTest extends BaseIntegraatioTesti {
  ...
  @Test def testLegacySuorituksetHenkilolleAllowed(capturedOutput: CapturedOutput): Unit =
    ...
    val ammatillinenTutkinto = AmmatillinenTutkinto("diplomi", Koodi(tutkintoKoodi, "koulutus", Some(1)), Oppilaitos(None, None, None, "1.2.3.4"), Koodi("valmistunut", "jokutila", Some(1)), Some(LocalDate.now()), None, Koodi("tapa", "suoritustapa", Some(1)), Koodi("kieli", "suorituskieli", Some(1)), Set.empty)
  ...
  @Test def testLegacySuorituksetMuuttuneetAllowed(): Unit =
    ...
    val ammatillinenTutkinto = AmmatillinenTutkinto("diplomi", Koodi("123456", "koulutus", Some(1)), Oppilaitos(None, None, None, "1.2.3.4"), Koodi("valmistunut", "jokutila", Some(1)), Some(LocalDate.now()), None, Koodi("tapa", "suoritustapa", Some(1)), Koodi("kieli", "suorituskieli", Some(1)), Set.empty)
